...
public interface LightPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default int print(int id)
        throws OutOfBoundry
    {
        return print(id, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default int print(int id, java.util.Map<String, String> context)
        throws OutOfBoundry
    {
        try
        {
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Integer> printAsync(int id)
    {
        return _iceI_printAsync(id, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> printAsync(int id, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> _iceI_printAsync(int iceP_id, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "print", null, sync, _iceE_print);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeInt(iceP_id);
                 }, istr -> {
                     int ret;
    ...
    default int[] all()
    {
        return all(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default int[] all(java.util.Map<String, String> context)
    {
        return _iceI_allAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<int[]> allAsync()
    {
        return _iceI_allAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<int[]> allAsync(java.util.Map<String, String> context)
    {
        return _iceI_allAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<int[]> _iceI_allAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<int[]> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "all", null, sync, null);
